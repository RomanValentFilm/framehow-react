          ...
          <div className="exp-field">
            ...
            <label className="exp-opt">
              ...
              <span className="exp-opt-wrap">
                <svg className="exp-opt-icon" width="76" height="54" viewBox="0 0 76 54">
                  <rect x="0.5" y="0.5" width="75" height="53" rx="2" fill="#222" stroke="#555" strokeWidth="0.8" />
                  <rect x="4" y="6" width="10" height="18" rx="1" fill="none" stroke="#999" strokeWidth="1.1" />
                  <rect x="17" y="6" width="10" height="18" rx="1" fill="#aaa" stroke="#666" strokeWidth="0.9" />
                  <rect x="30" y="6" width="10" height="18" rx="1" fill="#aaa" stroke="#666" strokeWidth="0.9" />
                  <rect x="43" y="6" width="10" height="18" rx="1" fill="#aaa" stroke="#666" strokeWidth="0.9" />
                  <rect x="56" y="6" width="10" height="18" rx="1" fill="#aaa" stroke="#666" strokeWidth="0.9" />
                  <line x1="4" y1="28" x2="66" y2="28" stroke="#666" strokeWidth="0.6" />
                  <line x1="4" y1="31" x2="50" y2="31" stroke="#555" strokeWidth="0.5" />
                  <rect x="4" y="36" width="62" height="12" rx="1" fill="none" stroke="#555" strokeWidth="0.6" />
                  <line x1="17" y1="36" x2="17" y2="48" stroke="#555" strokeWidth="0.5" />
                  <line x1="30" y1="36" x2="30" y2="48" stroke="#555" strokeWidth="0.5" />
                  <line x1="43" y1="36" x2="43" y2="48" stroke="#555" strokeWidth="0.5" />
                  <line x1="56" y1="36" x2="56" y2="48" stroke="#555" strokeWidth="0.5" />
                </svg>
                <span className="exp-opt-text">
